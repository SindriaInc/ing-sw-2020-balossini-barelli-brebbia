...
/**
 * The SocketHandler allows to receive and send messages to a socket
 */
public class SocketHandler {
    ...
    /**
     * Class constructor, initializes an inbound and outbound handler for the socket
     *
     * @param executorService The executor service
     * @param socket The socket
     * @param inboundMessageConsumer The inbound message consumer
     * @param errorMessageConsumer The error message consumer
     */
    ...
    /**
     * Handles an error generated by the socket
     *
     * @param message The message that was being sent
     */
