...
public interface ModelEventProvider {

    /**
     * Register the observer for RequestChallengerSelectGodsEvent in the related observable
     * @param observer The Observer
     */
    void registerRequestChallengerSelectGodsEventObserver(Observer<RequestChallengerSelectGodsEvent> observer);
     ...
     * @param observer The Observer
     */
    void registerChallengerSelectGodsEventObserver(Observer<ChallengerSelectGodsEvent> observer);
